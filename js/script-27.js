...
//! && запинаеться на лжи
console.log(2 && 1 && -53 && 0 && undefined); //! null - Остановился на превом ложном вырожении Null
...
//! && приоритет 6 / если два оператора true возвращает второй правдивый
//! || приоритет 5
//! У кого приоритет выше тот выполняеться первым
console.log(null || 2 && 3 || 4); //! 3 - таблица приорететов операторов в JS 
...
const a = [1, 2, 3]; 
const b = [1, 2, 3];
//! Два разных массива, массивы индентичны но они разные
...
console.log("Ёжик" > "яблоко"); //!  Сравнение символов по таблице Unicode

/* 12) Чему равно 0 || "" || 2 || undefined || true || falsе */

console.log(0 || "" || -5 || undefined || true || falsе); //? -5